...
import { Button, Grid, Hidden, TextField, InputAdornment } from '@material-ui/core';
...
function RedeemCheck(props) {
    ...
    <div style={{ display: 'flex' }}><Clear style={{ paddingBottom: '4px' }} /> <div>Already Generated</div></div> :
    <div style={{ display: 'flex' }}><Check style={{ paddingBottom: '4px' }} /> <div>Not Redeemed</div></div>;
